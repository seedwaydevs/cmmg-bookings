    ...
    <>
      <style>{`
        ...
        .hero-overlay-2 {
          position: absolute;
          inset: 0;
          background: linear-gradient(to top, rgba(5,5,5,0.98) 0%, rgba(5,5,5,0.0) 45%);
        }
        .hero-glow {
          position: absolute;
          top: -10%; right: -5%;
        ...
        .hero-live-dot {
          ...
          border-radius: 50%; background: #f05a1a;
        ...
        .hero-title em { font-style: normal; color: #f05a1a; }
        .hero-actions {
        ...
        .btn-primary-arrow { font-size: 1rem; line-height: 1; transition: transform 0.2s; }
        ...
        .hero-right {
          ...
          gap: 1.75rem; padding-bottom: 0.5rem;
        }
        .hero-divider { width: 100%; height: 1px; background: rgba(255,255,255,0.08); }
        .hero-desc {
          font-family: 'Manrope', sans-serif;
        ...
        .hero-tag:hover { border-color: rgba(26,140,255,0.5); color: #1a8cff; }
        ...
        .hero-meta-center { display: flex; align-items: center; gap: 1.25rem; }
        .hero-meta-sep {
          width: 4px; height: 4px;
          border-radius: 50%; background: #1a8cff; opacity: 0.5;
        }
